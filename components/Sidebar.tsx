...
import { Home, FileText, DollarSign, Calendar, CalendarDays, Bell, User, LogOut, Menu, X, Building2, Ticket, MessageCircle, ChevronRight, Zap, Wrench, Camera, Server } from 'lucide-react'
...
export default function Sidebar({ clientData, userData, unreadNotifications = 0, pendingQuotes = 0, onScanOpen }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { icon: Camera, label: 'Escanear QR', path: 'scanner', badge: null },
